...
const VerticalNav  = () => {
  ...
  return (
    ...
    <div  className=" footer w-16 text-lg flex flex-col   dark:bg-slate-800 dark:text-yellow-300 xs:bg-orange-100    xs:h-14 xs:p-1 xs:sticky xs:absolute xs:bottom-0    ">
