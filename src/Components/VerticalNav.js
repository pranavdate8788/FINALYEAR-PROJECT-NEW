...
const VerticalNav = () => {
  ...
  return (
    <div className=" footer w-16 bg-indigo-100 text-lg flex flex-col dark:bg-zinc-900 dark:text-yellow-300 xs:bg-orange-100 xs:h-14 xs:p-1 xs:absolute xs:bottom-0    ">
