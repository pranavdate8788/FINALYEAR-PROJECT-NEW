...
function FirstContetnt() {
  ...
  return (
    ...
    <div className="flex flex-wrap mt-3 justify-center  ">
      ...
      <div onClick={() => setShowComponent(true)}     className="h-auto p-4 w-80 m-3 bg-yellow-300 relative rounded-xl flex flex-col shadow-slate-600 ">
